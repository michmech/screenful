Screenful.Navigator={
  ...
  start: function(){
    ...
    $("#critbox").html("<div id='editor'></div><div class='buttons'><button class='iconYes' id='butCritCancel'><span>"+Screenful.Loc.cancel+"</span></button><button class='iconYes' id='butCritGo'><span>"+Screenful.Loc.find+"</span></button></div>");
